...
class DependancyParsing(pl.LightningModule):
    def __init__(self, model_name_or_path, learning_rate, adam_beta1, adam_beta2, adam_epsilon):
        ...
        self.model = RobertaForGraphPrediction.from_pretrained(model_name_or_path,config=config)

    def forward(self, x):
        # TODO: should return arcs and depts logits
        return self.model(x).logits

    def training_step(self, batch, batch_idx):
        # TODO: should sum arcs and depths
